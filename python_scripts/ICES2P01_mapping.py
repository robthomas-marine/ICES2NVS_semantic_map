...
param_combo = param_combo[['PARGROUP','PRNAM','CAS','DTYPE','PARAM','MUNIT','MATRX','BASIS','METPT','METOA','Note','AphiaID','Species','name_from_AphiaID',
...
chem_map_count = len(output_chem_mapped)
...
print("Rows for chemical substances: %s" % chemcount)
print("  Chemical rows for new code fully mapped: %s" % chem_map_count)
print("  Chemical rows for new code not fully mapped: %s" % (chemcount - chem_map_count))
...
summary.append(["Rows for chemical substances:", "%s" % chemcount])
summary.append(["  Chemical rows for new code fully mapped:", "%s" % chem_map_count])
summary.append(["  Chemical rows for new code not fully mapped:", "%s" % (chemcount - chem_map_count)])
